...
export function PortfolioProject(props: PortfolioProjectProps) {
  ...
  return (
    <div className="flex flex-wrap-reverse md:flex-nowrap max-w-[70rem] justify-center border-2 dark:border-slate-700 rounded-md border-slate-100 mb-10">
      <div className="flex flex-col space-y-4 md:w-[60%] items-center justify-between md:items-start  p-8">
        ...
        <div className="text-base text-justify md:text-start whitespace-pre-wrap">
          <p>{description}</p>
        </div>
