    ...
    <div className="flex flex-1 p-6 justify-center  bg-gradient dark:bg-gradientdark">
      <div className="flex items-center space-y-12 pt-6">
        <div className="flex justify-center space-x-6">
          ...
          />
          <div className="flex flex-col text-slate-800 border-4 border-violet-100 bg-violet-50 dark:bg-slate-800 dark:text-white dark:border-slate-700 px-10 py-16 rounded-[6rem] rounded-bl-none w-[22rem] space-y-6 ">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="space-y-0.5">
                <p className="text-xs font-semibold  dark:text-slate-700 text-slate-500 dark:text-slate-400">
                  Phone
                </p>
